<?php
	...
	if(!empty($search)):
		$data = array(
			array("id" => "search_root_1","text" => "Empresa 1 Search","icon"=> "io-City", "children"  => array(
			...
			array("id" => "search_root_2","text" => "Empresa 2 Search" ,"icon"=> "io-City", "children"  => array(
					array("id" => "search_child_3", "text" => "Hijo 2.2 Search Test", "icon"=> "io-City", "total" => 0)
				),  "total" => 1
			)
		);
